...
local HubTitleText = Create("TextLabel", {
    Name = "Text",
    Parent = HubTitle,
    BackgroundTransparency = 1,
...
-- Gradient cho Hub Title
local HubTitleGradient = Create("UIGradient", {
    Parent = HubTitleText,
...
task.spawn(function()
    while task.wait(0.03) do
        if HubTitleGradient and HubTitleGradient.Parent then
            HubTitleGradient.Rotation = (HubTitleGradient.Rotation + 2) % 360
        end
    end
end)
